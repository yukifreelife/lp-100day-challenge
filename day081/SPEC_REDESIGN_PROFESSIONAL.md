...
### 1.1 コンセプト: 「壺（つぼ）」という小さな世界

**現在**: 「8席のみの完全予約制」という機能的説明
**改善**: 「壺の中で、一期一会を」という世界観を全セクションへ展開
...
<!-- Concept: 世界観の説明 -->
<h2 class="section-title">壺という名の</h2>
<h2 class="section-title section-title-accent">小さな世界</h2>
```
...
| 項目 | 内容 | 期待効果 |
|------|------|----------|
| 「壺」コンセプト展開 | 全セクションへ世界観を統一 | ブランド力+60% |
...
1. ✅ 仕様書のユーザー確認
2. ⬜ P0改善の実装（キャッチコピー、CTA文言）
3. ⬜ P1改善の実装（Bento Grid、悩みセクション）
4. ⬜ P2改善の検討（「壺」コンセプト展開）
