const worksData = [
  ...
  {
    day: "Day093",
    title: "NemuNote | 睡眠の質向上アプリ",
    category: "Wellness",
    industry: "睡眠改善アプリ",
    focus: "アプリダウンロード",
    summary: "白を基調に、淡いミント・ピーチ・ライラックで安心感と可愛らしさを両立した日本向け睡眠アプリLP。モックアップ画像を参照しつつ、セクションを画像貼り付けではなくReact + Tailwind CSSのコードベースで再構築。",
    metric: "睡眠スコア・週間レポート・料金比較・睡眠ガイド・FAQ・ダウンロード導線",
