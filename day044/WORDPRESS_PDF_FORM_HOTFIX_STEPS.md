# Day044 - PDFフォーム no-JS ホットフィックス手順
...
- そのため、待機時間を使って Day044 側の正本を no-JS 運用へ整合させた。
...
3. その範囲を削除する
4. `/Users/yuuki/Works/lp-100/day044/PDF_FORM_RECAPTCHA_NOTE_OWNER_EMAIL.html` の内容を貼る
