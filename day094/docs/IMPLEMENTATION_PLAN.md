...
## Architecture
- Vite + React single page app under `day094/`.
...
- Page content is driven by a page manifest in `src/App.jsx`.
- Visual fidelity comes from full-bleed mockup images sized to 16:9, matching the generated reference proportions.

## Interaction
- Top fixed control bar for site-level navigation.
- Invisible/soft hotspot links mirror the mock navigation and CTA areas.
- Keyboard-accessible page switcher.
- Page transition animation on mockup swap.
- Subtle floating asset and glow effects using CSS keyframes.
