...
export const hero = {
  ...
  lead:
    "液体チョーク、ブラシ、バッグ、テープ、グリップバームを、ジム通いで使いやすい一式に。登る直前の迷いを減らし、グリップと携帯性を両立します。",
  ...
  stats: [
    ...
    { label: "携帯点数", value: "5点", note: "ジムバッグに収まる構成" },
...
export const liquidChalkDetail = {
  ...
  purchase: { label: "液体チョークをカートに入れる", href: "#cart", price: "¥1,980" },
  highlights: [
    "手汗を抑えてホールドへの接地感を安定",
    "粉チョーク前のベースとしても使用可能",
...
export const starterKitDetail = {
  ...
  image: productAsset("hero-starter-kit.png"),
  purchase: { label: "セットをカートに入れる", href: "#cart", price: "¥9,900" },
