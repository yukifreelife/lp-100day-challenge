...
## 記録について
- 当日の分単位の実測ログは見つからなかったため、このファイルは `README.md`、`NO_JS_PUBLISH_FIRST_PLAN.md`、Codex チャットのタイムスタンプをもとに再構成している。
...
- WAFブロックを前提にした公開方針の再設計: 約65分
- FAQの no-JS 代替案整理: 約35分
- PDFフォーム差し替え手順の明文化: 約40分
- 初回公開で残す機能 / 削る機能の整理と公開手順の固定: 約50分
- 参考合計: 約190分（3時間10分）
